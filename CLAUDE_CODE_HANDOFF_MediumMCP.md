...
### Success Criteria
- [ ] Server deploys to Render without errors
- [ ] Health endpoint responds at `/health`
- [ ] MCP tools accessible via SSE transport
- [ ] Can connect from Claude.ai via MCP connector
...
### Template Location
Create new repo: `G:\Apps\render-mcp-template` (or wherever Sean prefers)
...
- [ ] Can clone and deploy a working MCP server in <5 minutes
- [ ] Example tool demonstrates the pattern
- [ ] Both transports work (local + Render)
